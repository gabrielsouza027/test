...
def init_connection():
    ...
    try:
        ...
        st.write("Teste de conexão com Supabase:", response.data)
        return client
...
def get_all_data_from_supabase():
    if "all_data" not in cache:
        try:
            ...
            page_size = 1000
            offset = 0
            max_records = 100000  # Limite máximo de registros para evitar loops infinitos
            ...
            while True:
                ...
                try:
                    ...
                    st.write(f"Offset: {offset}, Registros retornados: {len(data_page)}")
                    if not data_page:
                        break
            ...
            st.write("Colunas retornadas:", df.columns.tolist())
